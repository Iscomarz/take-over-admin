<script>
	...
	onMount(async () => {
		...
		await Promise.all([cargarGenerosActivos(), cargarGenerosEvento(), cargarVenuesActivos()]);
...
<div class="min-h-screen bg-gradient-to-b from-black-900 to-stone-800 text-white pb-20">
	<div class="max-w-6xl mx-auto">
		...
		<div class="flex items-center justify-between mb-6">
			<div class="flex items-center gap-3 relative">
				...
				>
					...
					>
						<path
							d="M128,96a16,16,0,1,0,16,16A16,16,0,0,0,128,96Zm0-64a16,16,0,1,0,16,16A16,16,0,0,0,128,32Zm0,128a16,16,0,1,0,16,16A16,16,0,0,0,128,160Z"
						></path>
					</svg>
				</button>
				...
				{#if mostrarMenuOpciones}
					...
					<div
						class="absolute top-[115%] left-0 w-56 bg-stone-800 border border-stone-600 shadow-2xl rounded-xl z-50 overflow-hidden divide-y divide-stone-700/60 animate-in fade-in slide-in-from-top-2 duration-200"
					>
						<button
							on:click={() => {
								switchEditMode();
							...
							<span class="flex items-center gap-3">
								{#if evento.activo}
									...
									<svg
										...
										viewBox="0 0 256 256"
										><path
											d="M216,48V208a16,16,0,0,1-16,16H160a16,16,0,0,1-16-16V48a16,16,0,0,1,16-16h40A16,16,0,0,1,216,48ZM96,32H56A16,16,0,0,0,40,48V208a16,16,0,0,0,16,16H96a16,16,0,0,0,16-16V48A16,16,0,0,0,96,32Zm8,176a8,8,0,0,1-8,8H56a8,8,0,0,1-8-8V48a8,8,0,0,1,8-8H96a8,8,0,0,1,8,8Zm96-176H160a8,8,0,0,0-8,8V208a8,8,0,0,0,8,8h40a8,8,0,0,0,8-8V48A8,8,0,0,0,200,32Z"
										></path></svg
									>
									Desactivar Evento
								{:else}
									...
									<svg
										...
										viewBox="0 0 256 256"
										><path
											d="M232.31,114.34l-128-80a16,16,0,0,0-24.31,13.66v160a16,16,0,0,0,24.31,13.66l128-80a16,16,0,0,0,0-27.32ZM96,204.75V51.25L218.79,128Z"
										></path></svg
									>
									Activar Evento
								{/if}
		...
		{#if showModalVentas}
			<div class="fixed inset-0 z-[100] flex justify-center items-center p-4">
				...
				<div
					...
					on:click={() => (showModalVentas = false)}
				></div>
				<div
					class="relative bg-stone-900 border border-stone-700 rounded-2xl w-full max-w-lg p-6 flex flex-col max-h-[90vh]"
				>
					<div class="flex items-center justify-between mb-6">
						<h3 class="text-xl font-bold text-white">
							Desglose de Ventas ({estadisticasVentas.totalTickets} total)
						</h3>
						<button
						...
						>
							<svg
								...
								viewBox="0 0 256 256"
								><path
									d="M205.66,194.34a8,8,0,0,1-11.32,11.32L128,139.31,66.34,200.97a8,8,0,0,1-11.32-11.32L116.69,128,55.03,66.34A8,8,0,0,1,66.34,55.03L128,116.69l61.66-61.66a8,8,0,0,1,11.32,11.32L139.31,128Z"
								></path></svg
							>
						</button>
					</div>
								...
								<div class="flex justify-between items-center">
									<div class="flex-1 bg-stone-700 rounded-full h-1.5 mr-4 overflow-hidden">
										<div
											...
											style="width: {estadisticasVentas.totalTickets
												? (fase.cantidad / estadisticasVentas.totalTickets) * 100
												: 0}%"
										></div>
									</div>
									<p class="font-semibold text-green-400 text-sm">
		...
		<div class="mb-8 grid grid-cols-1 md:grid-cols-4 gap-4">
			...
			<div
				class="col-span-1 p-5 bg-gradient-to-br from-green-900/30 to-stone-900 border border-green-800/40 rounded-2xl shadow-lg relative flex flex-col justify-between"
			>
				<div>
					<h2 class="text-xs font-semibold text-green-400 mb-2 uppercase tracking-wider">
						Tickets Vendidos
					</h2>
					<p class="text-4xl font-bold text-white mb-1">{estadisticasVentas.totalTickets}</p>
					<p class="text-sm font-semibold text-green-400">
						{new Intl.NumberFormat('es-MX', { style: 'currency', currency: 'MXN' }).format(
							estadisticasVentas.totalMonto
						)}
					</p>
				</div>
				<button
			...
			<div
				class="col-span-1 md:col-span-3 p-5 bg-stone-900 border border-stone-800 rounded-2xl shadow-lg"
			>
				<h2 class="text-sm font-semibold text-stone-400 mb-4 uppercase tracking-wider">
					Herramientas Rápidas del Evento
				</h2>
				{#if evento.activo}
					<div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
						...
						>
							<div
								class="p-2 bg-blue-900/30 rounded-lg text-blue-400 group-hover:bg-blue-500 group-hover:text-black transition-colors"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="24"
									...
									viewBox="0 0 256 256"
									><path
										d="M224,40V216a16,16,0,0,1-16,16H48a16,16,0,0,1-16-16V40A16,16,0,0,1,48,24H208A16,16,0,0,1,224,40ZM104,112H72a8,8,0,0,0-8,8v32a8,8,0,0,0,8,8h32a8,8,0,0,0,8-8V120A8,8,0,0,0,104,112ZM96,144H80V128H96Zm88-32H152a8,8,0,0,0-8,8v32a8,8,0,0,0,8,8h32a8,8,0,0,0,8-8V120A8,8,0,0,0,184,112Zm-8,32H160V128h16Zm-64,40H72a8,8,0,0,0-8,8v16a8,8,0,0,0,8,8h40a8,8,0,0,0,8-8V192A8,8,0,0,0,112,184Zm-8,16H80v-8h24ZM80,96h24V72H80ZM208,40H48V216H208V40ZM176,96h16a8,8,0,0,0,8-8V64a8,8,0,0,0-8-8H160a8,8,0,0,0-8,8V80a8,8,0,0,0,8,8h16ZM168,72h16v8H168Zm-32,32v56a8,8,0,0,1-16,0V104A8,8,0,0,1,136,104Zm8,88v-8a8,8,0,0,0-16,0v8a8,8,0,0,0,16,0ZM184,168h-8v-8a8,8,0,0,0-16,0v24a8,8,0,0,0,8,8h16a8,8,0,0,0,0-16Z"
									></path></svg
								>
							</div>
							<div>
						...
						>
							<div
								class="p-2 bg-yellow-900/30 rounded-lg text-yellow-400 group-hover:bg-yellow-500 group-hover:text-black transition-colors"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="24"
									...
									viewBox="0 0 256 256"
									><path
										d="M227.32,28.68a16,16,0,0,0-15.66-4.08l-176,48a16,16,0,0,0-1.85,30.34l75.06,31.27,31.27,75.06a15.86,15.86,0,0,0,14.73,9.88h1.16a16,16,0,0,0,14.45-11.74l48-176A16,16,0,0,0,227.32,28.68ZM158.46,206.18,129.58,136.9a8,8,0,0,0-4.48-4.48L55.82,103.54l149-40.64Z"
									></path></svg
								>
							</div>
							<div>
				...
				{:else}
					<div
						class="flex items-center justify-center p-6 border-2 border-stone-800 border-dashed rounded-xl bg-stone-800/10"
					>
						<p class="text-stone-500 font-medium text-center text-sm md:text-base">
							Las herramientas rápidas solo están disponibles mientras el evento se encuentre
							activo.
						</p>
					</div>
				{/if}
		...
		{:else}
			<div class="mb-6 bg-stone-800/30 rounded-2xl border border-stone-700 overflow-hidden">
				...
				>
					...
					<svg
						xmlns="http://www.w3.org/2000/svg"
						class="w-5 h-5 text-stone-400 transition-transform {mostrarDatosGenerales
							? 'rotate-180'
							: ''}"
						viewBox="0 0 256 256"
						fill="currentColor"
					...
					<div class="p-6 border-t border-stone-700 bg-stone-800/20">
								...
								<form>
									<div class="space-y-6">
											...
											<div>
												...
												<div class="relative group">
													{#if imagePreviewUrl}
														...
														<div
															class="absolute bottom-2 left-2 bg-green-500 text-black text-[10px] font-bold px-2 py-1 rounded"
														>
															NUEVA IMAGEN
														</div>
													{:else if rutaImagen}
													...
													{:else}
														<div
															class="w-full h-48 bg-stone-700 rounded-xl flex items-center justify-center border-2 border-dashed border-stone-600"
														>
										...
										<div class="relative">
											<label
												for="generoInput"
												class="block text-sm font-medium mb-2 text-stone-300"
											>
												Géneros Musicales
						...
						{:else}
							...
							<div class="bg-stone-800/50 rounded-2xl p-6 border border-stone-700">
								...
								<div class="space-y-4">
									<div>
										<p class="text-sm font-semibold text-stone-400 mb-1">
											Descripción Corta (Feed)
										</p>
										<p class="text-base italic">
											{evento.descripcionCorta == null || evento.descripcionCorta == ''
										...
										{#if generos.length > 0}
											<div class="flex flex-wrap gap-2">
												{#each generos as genero}
													<div
														class="bg-green-900/40 text-green-300 px-3 py-1 rounded-lg text-sm border border-green-700/50"
													>
				...
				{/if}
				<!-- cierra if mostrarDatosGenerales -->
			</div>
			<!-- cierra div borde wrapper del acordeon -->
		{/if}
	</div>
</div>
